 ...
 * 
 * This module is an object that encapsulates 3 different possible 
 * patterns:
 *  1.  Request/Receive 
 *  2.  Event Aggregation 
 *  3.  Command
...
zw.ZPubSub = function () {
    ...
    /**
     * Gets the first defined element in an array.
     * 
     * This is an annotated method that will be attached to 
     * every array returned from the publish method.  
     * This method will NOT create a copy of the array and will 
     * instead loop over the array to find the first defined item. 
     * 
     * @this {Array}
     * 
     * @returns {Object}    The first defined, non-null object.  If no 
     *                      such object exists in the array, then this method 
     *                      returns null.
     */
    var firstDefined = function () {
        for (var index = 0, count = this.length; index < count; index += 1) {
     ...
     */
    pubsub.subscribe = function (msg, owner, callback) {
     ...
     */
    pubsub.unsubscribe = function (msg, owner, callback) {
        var callbacks = getSubscription(msg),
            modified = false;
     ...
     * @returns {boolean} True if the subscription list was modified, false otherwise.
     */
    pubsub.unsubscribeAll = function (owner) {
        var modified = false;
     ...
     */
    pubsub.register = function (topic) {
     ...
     */
    pubsub.deregister = function (topic) {
        var publishName =  'publish' + topic;
        var subscribeName = 'subscribe' + topic;
        var unsubscribeName = 'unsubscribe' + topic;
